...
// Displaying text
    ...
    // buttons
    {
        // group one
        {
            ...
            buttontwo.mousePressed(scoregroupone = [coalscore, litanyscore,    bangelscore,    springscore]);

            buttonseven = createButton("Be who you are and will be");
            buttonseven.position(10, 2*windowHeight + 30);
            buttonseven.mousePressed(scoregroupone = [coalscore, litanyscore,    bangelscore,    springscore]);

            buttonfifteen = createButton("Speak proudly to your children");
            buttonfifteen.position(10, 2*windowHeight + 60);
            buttonfifteen.mousePressed(scoregroupone = [coalscore, litanyscore,    bangelscore,    springscore]);

            buttonnineteen = createButton("Now insolent Aprils bedevil us")
            buttonnineteen.position(10, 2*windowHeight + 90);
            buttonnineteen.mousePressed(scoregroupone = [coalscore, 0,    0,    springscore]);
        }
        ...
        // group two
        {
            ...
            buttonthree.mousePressed(scoregrouptwo = [0*coalscore, litanyscore,    bangelscore,    0*springscore]);

            buttonfive = createButton("And when the sun rises we are afraid");
            buttonfive.position(10, 3.4*windowHeight + 30);
            buttonfive.mousePressed(scoregrouptwo = [0, litanyscore,    0,    springscore]);

            buttonfourteen = createButton("Each time you love");
            buttonfourteen.position(10, 3.4*windowHeight + 60);
            buttonfourteen.mousePressed(scoregrouptwo = [0, litanyscore,    bangelscore,    0]);

            buttonseventeen = createButton("At April and evening");
            buttonseventeen.position(10, 3.4*windowHeight + 90);
            buttonseventeen.mousePressed(scoregrouptwo = [0*coalscore, litanyscore,    0*bangelscore,    springscore]);
        }
        ...
        // group three
        {
            ...
            buttonone.mousePressed(scoregroupthree = [coalscore, litanyscore,    0*bangelscore,    springscore]);

            buttonsix = createButton("So it is better to speak");
            buttonsix.position(3*windowWidth/4, 4*windowHeight + 30);
            buttonsix.mousePressed(scoregroupthree = [0*coalscore, litanyscore,    bangelscore,    springscore]);

            buttontwelve = createButton("Remember our sun");
            buttontwelve.position(3*windowWidth/4, 4*windowHeight + 60);
            buttontwelve.mousePressed(scoregroupthree = [coalscore, 0*litanyscore,    bangelscore,    springscore]);
            ...
            buttonthirteen.mousePressed(scoregroupthree = [0*coalscore, litanyscore,    bangelscore,    springscore]);
        }
        ...
        // group four
        {
            ...
            buttoneight.mousePressed(scoregroupfour = [0*coalscore, litanyscore,    bangelscore,    springscore]);

            buttonnine = createButton("Do not let your head deny");
            buttonnine.position(10, 5.7*windowHeight + 30);
            buttonnine.mousePressed(scoregroupfour = [0*coalscore, litanyscore,    bangelscore,    springscore]);

            buttonten = createButton("If you do not learn to hate");
            buttonten.position(10, 5.7*windowHeight + 60);
            buttonten.mousePressed(scoregroupfour = [coalscore, litanyscore,    bangelscore,    0*springscore]);
