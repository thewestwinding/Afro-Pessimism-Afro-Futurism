...
<head>
  ...
  <title>Afro Futurism/Pessimism</title>
...
<body id="page-top">
  ...
  <!-- Services Section (edit into one of results sections)-->
  ...
  <footer class="bg-light py-5">
    <div class="container">
      ...
      <div class="small text-center text-muted">Untilted project by Zephyr Farah (2019)</div>
    </div>
  </footer>
